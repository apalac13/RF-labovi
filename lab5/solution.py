...
def figMetaData(file_path):
    ...
    if not img_doc.has_exif:
        ...
        print(
            f"LONGITUDE: {convertGPScoordinate(img_doc.gps_longitude, img_doc.gps_longitude_ref)}")
        print(
            f"LATITUDE: {convertGPScoordinate(img_doc.gps_latitude, img_doc.gps_latitude_ref)}")
